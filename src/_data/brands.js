 ...
 *
 * tags (Supporting text в макете) — сверены с Figma по ВСЕМ 5
 * брейкпоинтам (у каждого свой набор текстовых нод, поэтому дизайнер
 * теоретически мог заполнить не везде): 320/390/768/1000/1440 дают
 * одинаковый текст у всех девяти брендов, плейсхолдеров
...
module.exports = [
  ...
  { slug: "kermi", name: "Kermi", tags: "Радиаторы / Душевые / Вентиляция" },
